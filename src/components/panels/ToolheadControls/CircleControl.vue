    ...
    <div>
        <v-row>
            <v-col class="pa-0 mt-1">
                <svg width="100%" height="100%" viewBox="0 0 78 62" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" style="fill-rule: evenodd; clip-rule: evenodd; stroke-linejoin: round; stroke-miterlimit: 2">
                        ...
                        <g id="home_buttons" transform="matrix(0.804902,0,0,1,0.0430241,0)">
                            ...
                            <a :class="xHomeClass" @click="doHomeX">
                                <g id="home_x" transform="matrix(0.707107,-0.707107,0.707107,0.707107,-1.41799,4.05689)">
                                    <g id="home_button_x" class="home_button" transform="matrix(0.68689,0.68689,-0.68689,0.68689,3.87132,0.962447)">
                            ...
                            <a :class="yHomeClass" @click="doHomeY">
                                <g id="home_y" transform="matrix(0.707107,0.707107,-0.707107,0.707107,57.8807,-1.41799)">
                                    <g id="home_button_y" class="home_button" transform="matrix(0.68689,0.68689,-0.68689,0.68689,3.87132,0.962447)">
                                        <path :d="pathHomeButtonTop" />
                                    </g>
                                    <g transform="matrix(0.654426,0,0,0.654426,0.298666,4.01315)">
                            ...
                            <a :class="zHomeClass" @click="doHomeZ">
                                <g id="home_z" transform="matrix(-0.707107,0.707107,-0.707107,-0.707107,63.3555,57.8807)">
                                    <g id="home_button_z" class="home_button" transform="matrix(0.68689,0.68689,-0.68689,0.68689,3.87132,0.962447)">
                            ...
                            <a v-if="enableXYHoming" :class="xyHomeClass" @click="doHomeXY">
                                <g id="home_xy" transform="matrix(-0.707107,-0.707107,0.707107,-0.707107,4.05689,63.3555)">
                                    <g id="home_button_xy" class="home_button" transform="matrix(0.68689,0.68689,-0.68689,0.68689,3.87132,0.962447)">
                                        <path :d="pathHomeButtonBottom" />
                                    </g>
                                    <g transform="matrix(0.654426,0,0,0.654426,0.298666,4.01315)">
                            ...
                            <a v-else :class="xyzHomeClass" @click="doHome">
                                <g id="home_all" transform="matrix(-0.707107,-0.707107,0.707107,-0.707107,4.05689,63.3555)">
                                    <g id="home_button_all" class="home_button" transform="matrix(0.68689,0.68689,-0.68689,0.68689,3.87132,0.962447)">
                                        <path :d="pathHomeButtonBottom" />
                                    </g>
                        ...
                        <g id="step_buttons" transform="matrix(0.804902,0,0,1,0.0430241,0)">
                            ...
                            <g id="Z" transform="matrix(1.24239,0,0,1,-0.0534526,0)">
                                <g id="Bottom" :class="zStepClass" transform="matrix(-1,-1.52149e-16,9.85721e-17,-1,114.34,62)">
                                    <a class="step inner" @click="doSendMove(`Z${!reverseZ ? '-' : '+'}${stepsZ.length >= 0 ? stepsZ[0] : 0}`, feedrateZ)">
                                        <g transform="matrix(0.804902,0,0,1,0,0)"><path :d="zStepInner" /></g>
                                    </a>
                                    <a class="step inner-mid" @click="doSendMove(`Z${!reverseZ ? '-' : '+'}${stepsZ.length >= 1 ? stepsZ[1] : 0}`, feedrateZ)">
                                        <g transform="matrix(0.804902,1.2326e-32,-9.92118e-33,1,-5.71917e-15,-7.10543e-15)">
                                            <path :d="zStepInnerMid" />
                                        </g>
                                    </a>
                                    <a class="step outer-mid" @click="doSendMove(`Z${!reverseZ ? '-' : '+'}${stepsZ.length >= 2 ? stepsZ[2] : 0}`, feedrateZ)">
                                        <g transform="matrix(0.804902,0,0,1,0,0)">
                                            <path :d="zStepOuterMid" />
                                        </g>
                                    </a>
                                    <a class="step outer" @click="doSendMove(`Z${!reverseZ ? '-' : '+'}${stepsZ.length >= 3 ? stepsZ[3] : 0}`, feedrateZ)">
                                        <g transform="matrix(0.804902,0,0,1,0,0)">
                                            <path :d="zStepOuter" />
                                        </g>
                                    </a>
                            ...
                            <g id="XY">
                                <g id="Right" :class="xStepClass">
                                    <a class="step inner" @click="doSendMove(`X${reverseX ? '-' : '+'}${stepsXY.length >= 0 ? stepsXY[0] : 0}`, feedrateXY)">
                                        <g transform="matrix(0.48,0,0,0.48,19,19)">
                                            <path :d="xyStepInner" />
                                        </g>
                                    </a>
                                    <a class="step inner-mid" @click="doSendMove(`X${reverseX ? '-' : '+'}${stepsXY.length >= 1 ? stepsXY[1] : 0}`, feedrateXY)">
                                        <g transform="matrix(0.72,0,0,0.72,13,13)">
                                            <path :d="xyStepInnerMid" />
                                        </g>
                                    </a>
                                    <a class="step outer-mid" @click="doSendMove(`X${reverseX ? '-' : '+'}${stepsXY.length >= 2 ? stepsXY[2] : 0}`, feedrateXY)">
                                        <g transform="matrix(0.96,0,0,0.96,7,7)">
                                            <path :d="xyStepOuterMid" />
                                        </g>
                                    </a>
                                    <a class="step outer" @click="doSendMove(`X${reverseX ? '-' : '+'}${stepsXY.length >= 3 ? stepsXY[3] : 0}`, feedrateXY)">
                                        <g transform="matrix(1.2,0,0,1.2,1,1)">
                                            <path :d="xyStepOuter" />
                                        </g>
                                    </a>
                                </g>
                                <g id="Left" :class="xStepClass" transform="matrix(-1,-1.22465e-16,1.22465e-16,-1,61.9767,61.9767)">
                                    <a class="step inner" @click="doSendMove(`X${!reverseX ? '-' : '+'}${stepsXY.length >= 0 ? stepsXY[0] : 0}`, feedrateXY)">
                                        <g transform="matrix(0.48,0,0,0.48,19,19)">
                                            <path :d="xyStepInner" />
                                        </g>
                                ...
                                <g id="Bottom1" :class="yStepClass" transform="matrix(6.12323e-17,1,-1,6.12323e-17,61.9767,-1.77705e-14)">
                                    <a class="step inner" @click="doSendMove(`Y${!reverseY ? '-' : '+'}${stepsXY.length >= 0 ? stepsXY[0] : 0}`, feedrateXY)">
                                        <g transform="matrix(0.48,0,0,0.48,19,19)">
                                            <path :d="xyStepInner" />
                                        </g>
                                    </a>
                                    <a class="step inner-mid" @click="doSendMove(`Y${!reverseY ? '-' : '+'}${stepsXY.length >= 1 ? stepsXY[1] : 0}`, feedrateXY)">
                                        <g transform="matrix(0.72,0,0,0.72,13,13)">
                                            <path :d="xyStepInnerMid" />
                                        </g>
                                    </a>
                                    <a class="step outer-mid" @click="doSendMove(`Y${!reverseY ? '-' : '+'}${stepsXY.length >= 2 ? stepsXY[2] : 0}`, feedrateXY)">
                                        <g transform="matrix(0.96,0,0,0.96,7,7)">
                                            <path :d="xyStepOuterMid" />
                                        </g>
                                    </a>
                                    <a class="step outer" @click="doSendMove(`Y${!reverseY ? '-' : '+'}${stepsXY.length >= 3 ? stepsXY[3] : 0}`, feedrateXY)">
                                        <g transform="matrix(1.2,0,0,1.2,1,1)">
                                            <path :d="xyStepOuter" />
                                        </g>
                                    </a>
                                </g>
                                <g id="Top1" :class="yStepClass" transform="matrix(6.12323e-17,-1,1,6.12323e-17,7.10543e-15,61.9767)">
                                    <a class="step inner" @click="doSendMove(`Y${reverseY ? '-' : '+'}${stepsXY.length >= 0 ? stepsXY[0] : 0}`, feedrateXY)">
                                        <g transform="matrix(0.48,0,0,0.48,19,19)">
                                            <path :d="xyStepInner" />
                                        </g>
                    ...
                    <a v-if="existsQGL && actionButton === 'qgl'" id="tilt_adjust" :class="colorSpecialButton" @click="clickSpecialButton">
                    ...
                    <a v-else-if="existsZtilt && actionButton === 'ztilt'" id="tilt_adjust" :class="colorSpecialButton" @click="clickSpecialButton">
 ...
 */
const zStepOuter = 'M66.037,2.5C66.037,1.672 66.709,1 67.537,1L74.537,1C75.365,1 76.037,1.672 76.037,2.5L76.037,7.521C74.428,7.179 72.759,7 71.048,7C69.33,7 67.654,7.181 66.037,7.525L66.037,2.5Z'
const zStepOuterMid = 'M66.037,7.221C69.367,6.597 72.7,6.583 76.037,7.192L76.037,13.702C74.453,13.245 72.778,13 71.048,13C69.309,13 67.627,13.247 66.037,13.708L66.037,7.221Z'
const zStepInnerMid = 'M66.037,13.244C69.353,12.66 72.687,12.7 76.037,13.355L76.037,20.099C74.523,19.39 72.831,19 71.048,19C69.256,19 67.556,19.393 66.037,20.109L66.037,13.244Z'
const zStepInner =
 ...
 */
const engineOffIcon = 'M3.78 2.5L21.5 20.22l-1.27 1.28L18 19.27V20h-8l-2-2H5v-3H3v3H1v-8h2v3h2v-3l1.87-1.86L2.5 3.77L3.78 2.5M20 9v3h-2V8h-6V6h3V4H7.82l15 15H23V9h-3Z'

const { printer_state } = useBase()
const { homedAxes, enableXYHoming, feedrateXY, feedrateZ, existsQGL, existsZtilt, colorQuadGantryLevel, colorZTilt, actionButton, doHome, doHomeX, doHomeY, doHomeZ, doHomeXY, doQGL, doZtilt, doSend, doSendMove } = useControl()
const guiStore = useGuiStore()

const reverseX = computed(() => guiStore.control.reverseX)
const reverseY = computed(() => guiStore.control.reverseY)
const reverseZ = computed(() => guiStore.control.reverseZ)

const stepsXY = computed(() => {
    const steps = guiStore.control?.stepsCircleXY ?? []

    return Array.from(new Set([...(steps ?? [])])).sort((a, b) => a - b)
})

const stepsZ = computed(() => {
    const steps = guiStore.control?.stepsCircleZ ?? []
...
const stepTextClass = computed(() => {
    if (!homedAxes.value.includes('xy') || isPrinting.value) return ['disabled']

    return []
})

const xStepClass = computed(() => {
    if (!homedAxes.value.includes('x') || isPrinting.value) return ['disabled']

    return []
})

const yStepClass = computed(() => {
    if (!homedAxes.value.includes('y') || isPrinting.value) return ['disabled']

    return []
})

const zStepClass = computed(() => {
    if (!homedAxes.value.includes('z') || isPrinting.value) return ['disabled']

    return []
})

const xHomeClass = computed(() => {
    const classes = []
    if (homedAxes.value.includes('x')) classes.push('homed')
    if (isPrinting.value) classes.push('disabled')

    return classes
})

const yHomeClass = computed(() => {
    const classes = []
    if (homedAxes.value.includes('y')) classes.push('homed')
    if (isPrinting.value) classes.push('disabled')

    return classes
})

const xyHomeClass = computed(() => {
    const classes = []
    if (homedAxes.value.includes('xy')) classes.push('homed')
    if (isPrinting.value) classes.push('disabled')

    return classes
})

const xyzHomeClass = computed(() => {
    const classes = []
    if (homedAxes.value.includes('xyz')) classes.push('homed')
    if (isPrinting.value) classes.push('disabled')

    return classes
})

const zHomeClass = computed(() => {
    const classes = []
    if (homedAxes.value.includes('z')) classes.push('homed')
    if (isPrinting.value) classes.push('disabled')
...
const motorsOffClass = computed(() => {
    const classes = []
    classes.push(homedAxes.value !== '' ? 'primary' : 'warning')
    if (isPrinting.value) classes.push('disabled')
...
function clickSpecialButton() {
    ...
    else if (existsZtilt.value) return doZtilt()
}
</script>
