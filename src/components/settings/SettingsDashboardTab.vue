                ...
                <v-col class="text-center">
                    <v-btn-toggle v-model="currentViewport" class="mx-auto" mandatory>
                        ...
                        <v-btn value="widescreen">
                            ...
                            <v-icon end class="hidden-sm-and-down">{{ mdiMonitorScreenshot }}</v-icon>
...
const currentTab = computed(() => {
    switch (currentViewport.value) {
        case 'mobile':
            return SettingsDashboardTabMobile
        case 'tablet':
            return SettingsDashboardTabTablet
        case 'widescreen':
            return SettingsDashboardTabWidescreen
        default:
            return SettingsDashboardTabDesktop
    }
})
</script>
