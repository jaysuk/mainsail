<template>
    <div>
        <settings-miscellaneous-tab-light-groups v-if="page === 'groups'" :type="pageType" :name="pageName" @close="openPage()" />
        <settings-miscellaneous-tab-light-presets v-else-if="page === 'presets'" :type="pageType" :name="pageName" @close="openPage()" />
